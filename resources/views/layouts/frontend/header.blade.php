            ...
            <div class="col-lg-2 col-md-2">
                <div class="clv_left_header">
                    <div class="clv_logo">
                        {{-- <div class="row"> --}}
                            {{-- <div class="col-md-4"> --}}
                                <a href="index.html"><img src="{{ asset('template/frontend/giga/giga.png') }}" alt="Giga"  width="100px" /></a>    
                            {{-- </div> --}}
                            {{-- <div class="col-md-4">
                                <a href="index.html"><img src="{{ asset('template/frontend/giga/giga.png') }}" alt="Giga"  width="70px" /></a>    
                            </div> --}}
                        {{-- </div> --}}
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="address_block">
                                    ...
                                    <div class="header_location">
                                        <h5>phone in touch</h5>
                                        <p>( +62 )800-1234-1245</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="clv_menu">
                        <div class="clv_menu_nav">
                            <ul>
                                ...
                                <li><a href="service.html">Menu 3</a></li>
                                <li><a href="gallery.html">Menu 4</a></li>
                                <li>
                                ...
                                <li><a href="contact.html">Menu 6</a></li>
                            </ul>
                        </div>
                        <div class="cart_nav">
                            <ul>
                        ...
                        <a href="javascript:;" class="appointment_btn">appointment</a>
                    </div>
                </div>
            </div>
        </div>
