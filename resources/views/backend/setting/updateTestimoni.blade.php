        ...
        <div class="card-box">
            ...
            <form action="{{ route('testi.update', $testi->id )}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-6">
                        <input required type="text" value="{{$testi->nama}}" name="nama_client" placeholder="e.g.  Pupuk Organik" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-6">
                        <input required value="{{$testi->sebagai}}" name="jabatan" type="text" class="form-control">
                    ...
                    <div class="col-9">
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                ...
                                @else
                                    <img src="{{ asset('images/testi/'.$testi->pict) }}" alt="image" class="img-fluid" />
                                @endif
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-6">
                        <textarea name="testi" placeholder="e.g. Testimoni client" id="" cols="30" rows="10" class="form-control">{{$testi->testi}}</textarea>
                    </div>
                </div>
